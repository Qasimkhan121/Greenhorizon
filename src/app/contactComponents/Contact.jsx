...
const Contact = () => {
  ...
  return (
    <div className="bg-green">
      <div className="container mx-auto flex gap-4 flex-col items-center justify-center pt-20 pb-10 lg:py-28">
        ...
        <div className="w-[90%] lg:w-[80%] xl:w-[70%] mx-auto space-y-10 text-center my-6">
          <FormComp formName={"bottomForm"} setLoad={setLoad} type={"light"} />
